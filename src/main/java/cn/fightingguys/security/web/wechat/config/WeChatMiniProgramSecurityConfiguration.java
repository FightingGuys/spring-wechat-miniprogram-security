...
public class WeChatMiniProgramSecurityConfiguration {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception {
        WeChatMiniProgramSecurityConfigurer<HttpSecurity> securityConfigurer = new WeChatMiniProgramSecurityConfigurer<>();
        RequestMatcher endpointsMatcher = securityConfigurer.getEndpointsMatcher();
        http
